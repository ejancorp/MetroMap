(function(d3, _) {
    ...
    Grid.prototype.init = function() {
        ...
        this.svg = this.initGridElement();

        //set center
        this.svg.attr("transform", "translate(-500, -200)scale(0.5)");
     ...
     * @return {Void} No return
     */
    Grid.prototype.initGridElement = function() {
        var svg = d3.select(this.element)
            .append("svg")
            .attr("width", this.width)
            .attr("height", this.height)
            .style("fill", this.bgcolor)
            .call(d3.zoom().scaleExtent([1 / 3, 4]).on("zoom", function() {
